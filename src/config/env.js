...
const RULES = [
  ...
  // Database Generic (Generated by ./simaju init)
  { key: 'DB_HOST',     description: 'Database host',     required: false },
  { key: 'DB_PORT',     description: 'Database port',     required: false },
  { key: 'DB_DATABASE', description: 'Database name',     required: true,  when: () => !isDriver('sqlite') },
  { key: 'DB_USERNAME', description: 'Database username', required: true,  when: () => !isDriver('sqlite') && !isDriver('mongodb') },
